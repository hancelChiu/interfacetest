...
sender = 'qiuhanqiu@163.com'
receiver = '814779251@qq.com'
smtpserver = 'smtp.163.com'
username = 'qiuhanqiu@163.com'
password = 'qiu0604'
...
# 构造附件3（附件为HTML格式的网页）
att3 = MIMEText(open(r'F:\Python\python接口自动化\接口框架demo2.0\result\report.html', 'rb').read(), 'base64', 'utf-8')
